import { CommentWithAuthor } from "@/components/posts/Comment";

/**
 * Organizes comments into a hierarchical tree structure
 * @param comments Flat array of comments
 * @returns Array of top-level comments with nested replies
 */
export function organizeCommentsIntoTree(comments: CommentWithAuthor[]): CommentWithAuthor[] {
...
/**
 * Initialize the liked comments state from the comments array
 * @param comments Flat array of comments
 * @param currentUserId Current user's ID
 * @returns Record mapping comment IDs to boolean liked state
 */
export function initializeLikedCommentsState(
