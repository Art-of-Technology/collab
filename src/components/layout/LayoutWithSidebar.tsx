  ...
  return (
    <div className="min-h-screen bg-[#191919]">
      ...
      <Button 
        ...
        className={`fixed z-50 top-1/2 -translate-y-1/2 hidden md:flex items-center justify-center ${
          isCollapsed 
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        ...
        <div 
          ...
          } fixed top-16 bottom-0 left-0 bg-[#191919] border-r border-[#2a2929] z-30 overflow-y-auto transition-all duration-300 ease-in-out ${
        ...
        <main 
          className={`flex-1 pt-16 pb-8 px-2 md:px-4 overflow-y-auto bg-[#191919] transition-all duration-300 ease-in-out ${
