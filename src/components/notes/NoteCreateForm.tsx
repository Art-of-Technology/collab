...
export interface NoteCreateFormRef {
  requestClose: () => void;
}

export const NoteCreateForm = forwardRef<NoteCreateFormRef, NoteCreateFormProps>(
  ({ onSuccess, onCancel, workspaceId, onOpenChange }, ref) => {
...
NoteCreateForm.displayName = "NoteCreateForm"; 