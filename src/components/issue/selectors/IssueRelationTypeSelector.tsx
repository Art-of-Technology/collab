    ...
    <Popover>
      <PopoverTrigger asChild>
        <button
          disabled={disabled}
          className={cn(
            "inline-flex items-center gap-1.5 px-2 py-1 rounded text-xs h-auto leading-tight min-h-[24px]",
            "border border-[#2d2d30] bg-[#181818] hover:bg-[#1f1f1f]",
            "text-[#cccccc] hover:border-[#404040]",
