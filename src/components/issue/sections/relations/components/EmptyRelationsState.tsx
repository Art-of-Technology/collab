...
export function EmptyRelationsState({ onAddRelation, canEdit = true }: EmptyRelationsStateProps) {
  return (
    <div className="text-center py-6">
      <Link2 className="h-10 w-10 mx-auto mb-3 text-collab-600" />
      <p className="text-collab-400 text-sm mb-1">No relations</p>
      <p className="text-collab-500 text-xs mb-4">This issue doesn't have any relations yet</p>
      {canEdit && onAddRelation && (
        <Button 
          variant="outline" 
          size="sm"
          className="border-collab-600 hover:bg-collab-800 hover:border-collab-600 text-collab-400"
