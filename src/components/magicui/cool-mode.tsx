...
export const CoolMode: React.FC<CoolModeProps> = ({ children, options }) => {
  ...
  useEffect(() => {
    if (elementRef.current) {
      return applyParticleEffect(elementRef.current, options);
    }
  }, [options]);
  ...
  // Use forwardRef pattern to handle this properly
  return (
    <span ref={elementRef as any}>
      {children}
    </span>
  );
};
