...
import { CursorMCPInstaller } from "@/components/cursor/CursorMCPInstaller";
    ...
    <div className="max-w-3xl mx-auto px-4 py-6 overflow-x-hidden">
      ...
      <Tabs defaultValue="profile" className="mb-8">
        <TabsList className="bg-card/80 border border-border/40">
          ...
          <TabsTrigger value="cursor" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Cursor Integration</TabsTrigger>
        </TabsList>
