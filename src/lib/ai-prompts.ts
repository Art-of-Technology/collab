...
`,
  ...
  BOARD_NAME: (userEmail: string) => `You are a product naming expert. Your task is to analyze the provided project description and generate a concise, professional board name that clearly represents the project.
